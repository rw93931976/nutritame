<?php
/**
 * Demo Chat Endpoint - Simplified for demo mode
 */
...
function generateDemoResponse($message) {
    ...
    // Snack suggestions
    if (strpos($message_lower, 'snack') !== false) {
    ...
    // Carb counting
    if (strpos($message_lower, 'carb') !== false || strpos($message_lower, 'count') !== false) {
    ...
    // Restaurant dining
    if (strpos($message_lower, 'restaurant') !== false || strpos($message_lower, 'dining') !== false) {
